...
class SearchBarComponent {
    ...
    ngAfterContentChecked() {
        ...
        if (formControl) {
            this.subs.add(formControl.valueChanges.subscribe(() => {
                this.control = formControl;
            }));
        }
        this.setAriaInvalid();
    ...
    setAriaInvalid() {
        if (this.control) {
            if (this.control.invalid) {
                this.renderer.setAttribute(this.input.nativeElement, 'aria-invalid', 'true');
            }
            else {
                this.renderer.setAttribute(this.input.nativeElement, 'aria-invalid', 'false');
            }
        }
        else {
            this.renderer.removeAttribute(this.input.nativeElement, 'aria-invalid');
        }
    }
    setAriaAutocomplete() {
