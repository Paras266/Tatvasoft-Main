...
*-------------------------------------------------------------------------------------------*/
import { Renderer2, EventEmitter, ElementRef, OnChanges, OnInit, OnDestroy, Injector, AfterContentChecked } from '@angular/core';
 ...
 * @hidden
 */
export declare class SearchBarComponent implements OnChanges, OnInit, OnDestroy, AfterContentChecked {
